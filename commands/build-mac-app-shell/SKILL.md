---
name: build-mac-app-shell
description: Use when the user wants Codex to build or refactor a Mac-native SwiftUI
  app shell with NavigationSplitView, sidebar selection, detail and inspector
  panes, menus, toolbars, keyboard shortcuts, and a Settings scene.
