...
description: Use when the user wants to learn a dense concept from papers, courses,
  or source material by gathering context, splitting analysis across subagents,
  and producing a cited Markdown learning report with diagrams.
