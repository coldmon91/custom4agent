...
description: Use when the user wants to understand an unfamiliar codebase, trace
  a feature or request flow, map module ownership and data flow, identify validation
  and side effects, or find the next files to read before editing.
