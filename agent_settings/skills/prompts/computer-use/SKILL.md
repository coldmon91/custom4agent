---
name: computer-use
description: Use when the user wants Codex to operate Mac apps with Computer Use
  by clicking, typing, navigating windows or browser sessions, moving information
  across apps, or completing multi-step desktop tasks.
