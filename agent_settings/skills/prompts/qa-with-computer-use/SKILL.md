---
name: qa-with-computer-use
description: Use when the user wants Codex to run a structured QA pass with Computer
  Use, exercise real app flows, identify issues, and produce a bug report with
  repro steps, expected and actual results, severity, and triage notes.
