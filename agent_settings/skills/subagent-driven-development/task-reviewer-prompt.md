...
Subagent:
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    The implementer already ran the tests and reported test results
    ...
    **Code quality:**
    ...
    - DRY without premature abstraction — is common behavior reused through
      functions/modules rather than duplicated?
    - Edge cases handled?
    - Naming clean and meaningful?
    - Any obvious security or resource-handling defect?
