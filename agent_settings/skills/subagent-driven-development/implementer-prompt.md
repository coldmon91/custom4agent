...
Subagent:
  ...
  prompt: |
    ...
    **Difficulty: Level [1-5]** — [one-line rationale]
    ...
    **While you work:** If you encounter something unexpected or unclear, **ask questions**.
    ...
    Set a timeout on any long-running process or script you launch, and kill
    any background process you started before you report back.
    ...
    - Comments in English, core logic only — no diff or change notes.
    ...
    **How to escalate:** Report back with status BLOCKED or NEEDS_CONTEXT. Describe
    ...
    The controller can provide more context, re-dispatch at a higher difficulty Level,
    ...
    **Quality:**
    ...
    - Is error handling thorough, and is the code secure?

    **Discipline:**
    - Did I avoid overbuilding (YAGNI)?
    - Did I only build what was requested?
    - Did I follow existing patterns in the codebase?
    - Did I reuse common behavior through functions/modules instead of duplicating it?
