...
- Rate each task's implementation difficulty (Level 1 ~ 5) and pick the subagent model per the project's model-selection rules. State the Level and a one-line rationale in the dispatch prompt.
