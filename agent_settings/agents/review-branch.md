...
Judge the branch as a single unit of work. Per-hunk defects are the job of `review-small` and
`review-complex`; you look for what only shows up when the whole branch is read together.
